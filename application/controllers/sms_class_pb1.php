...
class sms_class_pb1 extends CI_Controller {
...
//                KONFIGURASI Pagination
        ...
        $perpage = 10;
        $config = array(
            'base_url' => base_url() . 'sms_class_pb1/data_grafik/',
...
// 		$bar_stack->set_colours( array( '#568203','#FF1493','#EEEE00' ) );
// 		$bar_stack->set_keys(
// 				array(
// 						new bar_stack_key( '#568203', 'Attempt', 10 ),
// 						new bar_stack_key( '#FF1493', 'Delivered', 10 ),
// 						new bar_stack_key( '#EEEE00', 'Delivered < 10s', 10 ),
// 				)
// 		);
        ...
        foreach ($row ['query'] as $data) {
            ...
            //$bar_stack->append_stack( array($data_6[$i],$data_5[$i]-$data_6[$i],$data_4[$i]-($data_6[$i]+$data_5[$i])));
// 				$bar_stack->append_stack( array($data_6[$i],$data_5[$i]-$data_6[$i],$data_4[$i]-$data_5[$i]));
// 				$bar_stack->set_tooltip( '[#x_label#], Total [#total#]' );
// 				$i++;
        }


        $y_axis = array(200000000, 540000000, 20000000);
        ...
        $line_3->set_width(3);
        $line_3->set_colour('#00CD66');
        $line_3->set_values($data_3);
        $line_3->set_key("Less than 10s", 10);
